...
5. 겹자음을 연타로 입력하고 복모음의 조합(신광조의 신세벌식)을 활용하여 영문자 26개의 글쇠에 배치함.
...
1. 이 방식의 조합 규칙을 사용하면, Qwerty자판에서 기호를 그대로 사용하면서 알파벳에만 한글 세벌 자모를 배치할 수 있다. 물론 효율적인 배치를 연구해야 한다.
